...
function TestimonialCard({ img, client, title, clientInfo, clientImage }) {
  return (
    <Card
      shadow={false}
      className="bg-gray-100 shadow-lg rounded-2xl p-6 py-6 w-[95%] h-[40vh] lg:h-[40vh] flex flex-col justify-between"
    >
      <CardHeader color="transparent" floated={false} shadow={false} className="flex items-center">
        <Typography color="blue-gray" className="lg:mb-20 mb-4 text-md lg:text-xl font-bold my-auto text-justify">
          &quot;{title}&quot;
        </Typography>
      </CardHeader>
      <CardBody className="px-2 lg:px-4 py-0 flex flex-wrap gap-x-6 justify-between">
        <div>
          <div className="flex flex-wrap gap-3">
            ...
            <div>
              <Typography variant="h6" color="blue-gray" className="!text-red-800">
                {client}
              </Typography>
