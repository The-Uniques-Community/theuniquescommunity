...
const index = () => {
  ...
  return (
    <div>
      ...
      <section>
        <div class="">
          <section class="relative lg:h-screen bg-gray-50">
            <div class="px-4 py-12 sm:py-16 sm:px-6 lg:px-0 lg:max-w-7xl lg:mx-auto lg:py-24 xl:py-36 lg:grid lg:grid-cols-2">
              <div class="lg:pr-8">
                <div class="max-w-md mx-auto sm:max-w-lg lg:mx-0">
                  <img src={tu} className="mb-5 w-full object-center" alt="" />
                  <h1 class="text-xl font-medium text-gray-900 sm:text-xl lg:text-xl">
                    Community of designers{" "}
                    <span class="inline">
                      <img
                        class="inline w-auto h-5 sm:h-7 lg:h-8"
                  ...
                  <form action="#" method="post" class="relative mt-4">
                    <div class="absolute transitiona-all duration-1000 opacity-30 inset-0 bg-gradient-to-r from-black via-[#FF44EC] to-[#ca0019] rounded-xl blur-lg filter group-hover:opacity-100 group-hover:duration-200"></div>
