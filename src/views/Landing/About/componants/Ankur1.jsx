...
const ProfileCard = ({ isOpen, onClose }) => {
  ...
  return (
    <Modal isOpen={isOpen} sx={{marginTop:"40px"}} onClose={onClose}>
      <div className="bg-gray-50  w-[90%]  rounded-xl max-h-[80vh] mx-auto overflow-auto">
        <div className="p-6 flex flex-col lg:flex-row items-center space-y-6 lg:space-y-0 lg:space-x-6 relative mx-auto">
          ...
          <motion.div
            ...
            className="w-24 h-24 bg-white rounded-2xl shadow-md flex flex-col items-center justify-center p-3 text-center text-xs"
          >
            <img
              src={ankurImg}
              alt="Manager"
