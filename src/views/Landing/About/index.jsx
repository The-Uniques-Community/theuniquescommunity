                    ...
                    <Chip
                        ...
                        label={
                            <Stack direction="row" alignItems="center" spacing={1}>
                                <Typography variant="caption" className="MuiTypography-root">
                                    Over 200+
                                </Typography>
                                <Chip sx={{
                                    ...
                                    icon={
                                        <Person2OutlinedIcon
                                            ...
                                            sx={{ width: 24, height: 24, stroke:"white", color:"white" }}
                                        />
                                    }
                                    label={
                                        <Typography variant="caption" className="MuiTypography-root text-white ">
                                            Design Blocks
                                        </Typography>
                                    }
                                    variant="filled"
