      ...
      <div className="max-w-screen-xl mx-auto  my-5">
              ...
              <div className=" items-center -mx-3 sm:-mx-4">
                ...
                <div className="w-full px-3 sm:px-4 xl:w-9/12">
                  <div className="relative z-10 my-4">
                    <img src={mern} alt="" className="w-full rounded-2xl" />
        ...
        >
          ...
          <h2 className="text-3xl lg:text-4xl font-bold mb-8">
            A structured path to mastering technology and professional skills.
          </h2>
          <div className="text-gray-600 my-6 ">
            Our comprehensive curriculum is designed to provide hands-on
            experience in cutting-edge technologies and essential soft skills.
            From foundational design principles to advanced backend development
