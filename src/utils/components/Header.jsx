...
const Header = ({
    ...
    return (
        <Box
            ...
            sx={{
                overflow: "hidden",
                background: backgroundPattern || `url('data:image/svg+xml;utf8,<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 50 60"><text x="0" y="25" fill="%23E6E8EE" font-size="60px">.</text></svg>') 0px 0px / 30px 30px rgb(241, 244, 249)`,
                padding: "2rem 0",
            }}
        >
            <Container maxWidth="lg">
                ...
                >
                    ...
                    <Chip
                        ...
                        label={
                            ...
                            >
                                ...
                                >
                                    {chipData?.count || "Over 200+"}
                                </Typography>
                                <Chip
                                    sx={{
                                        backgroundColor: chipData?.chipBgColor || "#ca0019",
                                        height: "20px",
                                        padding: "0 8px",
                                        "& .MuiChip-icon": {
                                            color: "white",
                    ...
                    >
                        {heading || "More Than a Community → The Uniques ✦"}
                    </Typography>
