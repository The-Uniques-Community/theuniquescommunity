...
const Navbar = () => {
  ...
  return (
    <motion.nav
      ...
      className="lg:px-16 py-4 md:px-12 sm:px-8 px-5 grid grid-cols-2 lg:grid-cols-3 fixed top-0 left-0 w-full z-[999] bg-white/90 dark:bg-neutral-900/90 border-b border-gray-200/50 dark:border-neutral-800/50 items-center shadow-[0_2px_15px_-3px_rgba(0,0,0,0.07),0_10px_20px_-2px_rgba(0,0,0,0.04)] backdrop-blur-xl"
    >
